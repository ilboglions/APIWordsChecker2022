...
def main():
    ...
    ap.add_argument('-n', '--dict-size', dest='dict_size', type=int, default=400000,
    ...
    ap.add_argument('-g', '--n-games', dest='games', type=int, default=40,
                    help='Numero di partite')
    ap.add_argument('-i', '--p-insert', dest='p_insert', type=float, default=0.7,
                    help='Probabilità di inserire comandi di inserimento')
    ap.add_argument('-j', '--insert-min', dest='insert_min', type=float, default=0,
                    help='Minimo numero di parole inseribili in un comando di inserimento')
    ap.add_argument('-J', '--insert-max', dest='insert_max', type=float, default=100,
                    help='Massimo numero di parole inseribili in un comando di inserimento')
    ap.add_argument('-e', '--game-p-inv', dest='game_p_inv', type=float, default=0.5,
                    help='Probabilità di inserire una parola invalida in una partita')
    ap.add_argument('-f', '--game-p-filter', dest='game_p_filter', type=float, default=0.5,
                    help='Probabilità di inserire una richiesta di stampa parole filtrate in una partita')
    ap.add_argument('-m', '--game-len-min', dest='game_len_min', type=int, default=10,
                    help='Lunghezza minima di una partita')
    ap.add_argument('-M', '--game-len-max', dest='game_len_max', type=int, default=30,
